...
const defaultResult = [
  ...
  { name: 'Piperacilline/Tazobactam', value: 0, isDefault: true },
  { name: 'Ceftriaxone', value: 0, isDefault: true },
  ...
  { name: 'Cotrimoxazole', value: 0, isDefault: true },
  { name: 'Vancomycine', value: 0, isDefault: true },
  { name: 'Clindamycine', value: 0, isDefault: true },
  { name: 'Azithromycine', value: 0, isDefault: true },
  { name: 'Metronidazole', value: 0, isDefault: true },
  { name: 'Fosfomycine', value: 0, isDefault: true },
  { name: 'Ofloxacine', value: 0, isDefault: true },
];

const mappedResult = [
  { name: 'Amoxicilline', label: 'Amoxicilline' },
  { name: 'Amoxicilline/Acide Clavulanique', label: 'Amoxicilline/Acide Clavulanique' },
  { name: 'Oxacilline / Cefazoline', label: 'Oxacilline / Cefazoline' },
  { name: 'Piperacilline/Tazobactam', label: 'Piperacilline/Tazobactam' },
  { name: 'Ceftriaxone', label: 'Ceftriaxone' },
  ...
  { name: 'Cotrimoxazole', label: 'Cotrimoxazole' },
  { name: 'Vancomycine', label: 'Vancomycine' },
  { name: 'Clindamycine', label: 'Clindamycine' },
  { name: 'Azithromycine', label: 'Azithromycine' },
  { name: 'Metronidazole', label: 'Metronidazole' },
  { name: 'Fosfomycine', label: 'Fosfomycine' },
  { name: 'Ofloxacine', label: 'Ofloxacine' },
];
...
const HomePage = () => {
  ...
  const handleChangeInfection = (name: string, value: string | null) => {
